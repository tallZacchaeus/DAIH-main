...
import { FileText, ShieldCheck, Loader2, ArrowLeft } from "lucide-react";
...
export default function WebTermsPage() {
  ...
  useEffect(() => {
    ...
    api.policies
      ...
      .catch((err) => {
        console.warn("Could not load Terms of Service:", err);
      })
      .finally(() => {
            ...
            <div className="row">
              <div className="col-md-12 text-center">
                ...
                <p className="lead text-white-50 mt-2">
                  Membership guidelines, workspace rules, and facility policies.
                </p>
              </div>
              ...
              <div className="bg-white p-4 p-md-5 rounded-4 shadow-sm border border-light-subtle">
                <div className="d-flex flex-wrap align-items-center justify-content-between pb-4 mb-4 border-bottom gap-2">
                  <div className="d-flex align-items-center gap-3">
                    <div
                      className="rounded-3 p-3 text-white d-flex align-items-center justify-center"
                      style={{ backgroundColor: "#23055c" }}
                    >
                  ...
                  <span className="badge bg-purple-subtle text-purple px-3 py-2 rounded-pill border">
