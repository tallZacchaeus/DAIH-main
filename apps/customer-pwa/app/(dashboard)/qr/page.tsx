      ...
      <div className="max-w-md mx-auto space-y-4">
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {(() => {
              const now = new Date();
              const bStart = new Date(confirmedBooking.startTime);
              const bEnd = new Date(confirmedBooking.endTime);
              const todaySlotEnd =
              ...
              const isSlotConcludedToday = now >= todaySlotEnd;

              const isCheckedInToday = Boolean(
                (confirmedBooking.checkedInToday && !isSlotConcludedToday) ||
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 text-center space-y-4 shadow-sm">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500 max-w-xs mx-auto">
                You do not have a currently active workspace reservation. Past
                or missed bookings cannot be used for access.
              </p>
            </div>
